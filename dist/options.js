...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  background-color: #f5f5f5;\n  font-family: 'Roboto'\n}\n", "",{"version":3,"sources":["webpack://./src/options/options.css"],"names":[],"mappings":"AAAA;EACE,yBAAyB;EACzB;AACF","sourcesContent":["body {\n  background-color: #f5f5f5;\n  font-family: 'Roboto'\n}\n"],"sourceRoot":""}]);
// Exports
...
const App = () => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.getStoredOptions)().then((options) => {
            setOptions(options);
        });
    }, []);
    ...
    const handleSaveButtonClick = () => {
        setFormState('saving');
        (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.setStoredOptions)(options).then(() => {
            setTimeout(() => {
                setFormState('ready');
            }, 1000);
        });
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_7__.default, null,
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_8__.default, { container: true, direction: "column", spacing: 4 },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_8__.default, { item: true },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_10__.default, { fullWidth: true, placeholder: "Enter a home city name", value: options.homeCity, onChange: (event) => handleHomeCityChange(event.target.value), disabled: isFieldDisabled })),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_8__.default, { item: true },
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_9__.default, { variant: "body1" }, "Auto toggle overlay"),
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_11__.default, { color: "primary", value: options.hasAutoOverlay, onChange: (event, checked) => handleAutoOverlayChange(checked), disabled: isFieldDisabled })),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_8__.default, { item: true },
